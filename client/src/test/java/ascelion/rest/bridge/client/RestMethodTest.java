...
public class RestMethodTest
{
	...
	private ConvertersFactory cvsf;

	@Before
	public void setUp()
	{
		this.cvsf = new ConvertersFactory( this.mc.client );
	}
